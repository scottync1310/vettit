    ...
    return (
      <div style={{ maxWidth: "480px", margin: "80px auto", textAlign: "center", padding: "0 24px" }}>
        ...
        <div style={{ border: "1px solid #ebebeb", borderRadius: "2px", padding: "14px 16px", marginBottom: "24px", textAlign: "left" }}>
          <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".07em", marginBottom: "10px" }}>Site summary</div>
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", fontSize: "12px" }}>
              <div style={{ color: "#888" }}>Site name</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", fontSize: "12px" }}>
              <div style={{ color: "#888" }}>Supervisor</div>
              <div style={{ color: "#111" }}>{form.supervisorFirst} {form.supervisorLast}</div>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", fontSize: "12px" }}>
              <div style={{ color: "#888" }}>Mobile</div>
    ...
    <div>
      <div style={{ padding: "14px 32px", borderBottom: "1px solid #d0d0d0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          ...
          <div style={{ fontSize: "12px", color: "#888", marginTop: "2px" }}>Create a site to start inviting contractors</div>
        </div>
        <a href="/sites" style={{ fontSize: "12px", color: "#888", textDecoration: "none" }}>← Back to sites</a>
      </div>
      ...
      <div style={{ maxWidth: "560px", margin: "32px auto", padding: "0 24px 64px" }}>
        ...
        <div style={{ border: "1px solid #d0d0d0", borderRadius: "2px", overflow: "hidden", marginBottom: "16px" }}>
          <div style={{ padding: "12px 16px", background: "#fafafa", borderBottom: "1px solid #d0d0d0" }}>
            <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em" }}>Site details</div>
          </div>
        ...
        <div style={{ border: "1px solid #d0d0d0", borderRadius: "2px", overflow: "hidden", marginBottom: "24px" }}>
          <div style={{ padding: "12px 16px", background: "#fafafa", borderBottom: "1px solid #d0d0d0" }}>
            <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em" }}>Site supervisor</div>
            <div style={{ fontSize: "11px", color: "#aaa", marginTop: "2px" }}>Primary contact for this site — receives compliance alerts</div>
          </div>
          <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "14px" }}>
