    ...
    <div>
      <div style={{ padding: "14px 32px", borderBottom: "1px solid #d0d0d0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          ...
          <div style={{ fontSize: "12px", color: "#888", marginTop: "2px" }}>Upload a CSV to invite multiple contractors at once</div>
        </div>
        <a href="/" style={{ fontSize: "12px", color: "#888", textDecoration: "none" }}>← Back to dashboard</a>
      </div>
        ...
        {step === "upload" && (
          <div>
            <div style={{ marginBottom: "24px" }}>
              <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: "12px" }}>Step 1 — upload your CSV file</div>
              <div
              ...
              >
                ...
                <div style={{ fontSize: "12px", color: "#888", marginBottom: "16px" }}>or click to browse</div>
            ...
            <div style={{ marginBottom: "24px" }}>
              <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: "10px" }}>CSV format required</div>
              <div style={{ border: "1px solid #d0d0d0", borderRadius: "2px", overflow: "hidden" }}>
                <div style={{ padding: "8px 14px", background: "#fafafa", borderBottom: "1px solid #d0d0d0", fontSize: "11px", color: "#888" }}>Required columns — Company Name, Contact Name, Email, Trade</div>
            ...
            <div style={{ textAlign: "center" }}>
              <button
                ...
                style={{ fontSize: "12px", color: "#888", background: "none", border: "none", cursor: "pointer", textDecoration: "underline", fontFamily: "Roboto, sans-serif" }}
              >
        ...
        {step === "review" && (
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
              <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em" }}>Step 2 — review and fix errors</div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                <thead>
                  <tr style={{ background: "#fafafa" }}>
                    <th style={{ width: "24%", fontSize: "11px", fontWeight: 500, color: "#888", textAlign: "left", padding: "8px 12px", borderBottom: "1px solid #d0d0d0" }}>Company</th>
                    <th style={{ width: "20%", fontSize: "11px", fontWeight: 500, color: "#888", textAlign: "left", padding: "8px 12px", borderBottom: "1px solid #d0d0d0" }}>Contact</th>
                    <th style={{ width: "28%", fontSize: "11px", fontWeight: 500, color: "#888", textAlign: "left", padding: "8px 12px", borderBottom: "1px solid #d0d0d0" }}>Email</th>
                    <th style={{ width: "16%", fontSize: "11px", fontWeight: 500, color: "#888", textAlign: "left", padding: "8px 12px", borderBottom: "1px solid #d0d0d0" }}>Trade</th>
                    <th style={{ width: "12%", fontSize: "11px", fontWeight: 500, color: "#888", textAlign: "left", padding: "8px 12px", borderBottom: "1px solid #d0d0d0" }}></th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map((row) => (
                    <tr key={row.id} style={{ borderBottom: "1px solid #ebebeb", background: row.status === "error" ? "#fff8f8" : "#fff" }}>
                      ...
                      <td style={{ padding: "8px 12px", textAlign: "center" }}>
                        <span onClick={() => removeRow(row.id)} style={{ fontSize: "14px", color: "#aaa", cursor: "pointer" }}>×</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div style={{ marginBottom: "20px" }}>
              <div style={{ fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: "10px" }}>Vetting for which sites</div>
              <div style={{ border: "1px solid #d0d0d0", borderRadius: "2px", overflow: "hidden" }}>
                {sites.map((s, i) => (
        ...
        {step === "sent" && (
          <div style={{ textAlign: "center", padding: "48px 0" }}>
            ...
            <div style={{ border: "1px solid #ebebeb", borderRadius: "2px", overflow: "hidden", display: "inline-block", textAlign: "left", marginBottom: "24px", minWidth: "300px" }}>
              <div style={{ padding: "8px 14px", background: "#fafafa", borderBottom: "1px solid #ebebeb", fontSize: "10px", fontWeight: 500, color: "#999", textTransform: "uppercase", letterSpacing: ".07em" }}>Invites sent to</div>
              {rows.filter((r) => r.status === "sent").map((r) => (
                <div key={r.id} style={{ padding: "9px 14px", borderBottom: "1px solid #ebebeb", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div>
                    ...
                    <div style={{ fontSize: "11px", color: "#888", marginTop: "1px" }}>{r.email}</div>
                  </div>
