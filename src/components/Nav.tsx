...
export default function Nav() {
  ...
  const isAddActive = pathname.startsWith("/contractor/invite") || pathname.startsWith("/contractor/add") || pathname === "/bulk-invite";
            ...
            <div ref={dropdownRef} style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  color: isAddActive ? "#111" : "#888",
                  borderBottom: isAddActive ? "2px solid #111" : "2px solid transparent",
