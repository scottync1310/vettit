  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", fontFamily: "Montserrat, sans-serif" }}>
      ...
      <div style={{ marginBottom: "40px" }}>
        <img src="/logo.png" alt="Vettit" style={{ height: "44px", width: "auto" }} />
      </div>
      ...
      <div style={{ maxWidth: "480px", width: "100%", textAlign: "center" }}>
            ...
            <div key={unit.label} style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                <div style={{ fontSize: "52px", fontWeight: 700, color: "#111", lineHeight: 1, letterSpacing: "-2px" }}>
                  {i === 0 ? timeLeft.days : pad(unit.val)}
                </div>
        ...
        <div style={{ borderTop: "1px solid #ebebeb", paddingTop: "40px" }}>
          ...
          <div style={{ display: "flex", gap: "8px", justifyContent: "center" }}>
            <input
              ...
              type="password"
              style={{ padding: "10px 14px", border: error ? "1px solid #c0392b" : "1px solid #d0d0d0", fontSize: "14px", color: "#111", borderRadius: "2px", fontFamily: "Montserrat, sans-serif", width: "200px", background: error ? "#fff8f8" : "#fff", letterSpacing: ".1em" }}
            />
            <button
              onClick={handleSubmit}
              style={{ padding: "10px 20px", border: "1px solid #111", background: "#111", color: "#fff", fontSize: "13px", fontWeight: 500, borderRadius: "2px", cursor: "pointer", fontFamily: "Montserrat, sans-serif" }}
            >
              Enter
            </button>
          </div>
